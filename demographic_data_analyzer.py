...
def calculate_demographic_data(print_data=True):
    ...
    rich_percentage = len(num_min_workers[num_min_workers.salary == ">50K"] / len(num_min_workers) * 100, 1)
    ...
    highest_earning_country_percentage = ((country_rich_count / country_count * 100).max(), 1)
